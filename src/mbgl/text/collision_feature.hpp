...
namespace mbgl {
    ...
    class CollisionFeature {
        public:
            // for text
            inline explicit CollisionFeature(const Coordinates &line, const Anchor &anchor,
            ...
            explicit CollisionFeature(const Coordinates &line, const Anchor &anchor,
        ...
        private:
            void bboxifyLabel(const Coordinates &line, Coordinate &anchorPoint, const int segment, const float length, const float height);
    };
} // namespace mbgl
