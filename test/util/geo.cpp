...
TEST(LatLngBounds, World) {
    ...
    ASSERT_DOUBLE_EQ(-util::LATITUDE_MAX, result.south());
    ASSERT_DOUBLE_EQ(util::LATITUDE_MAX, result.north());
    ASSERT_DOUBLE_EQ(-util::LONGITUDE_MAX, result.west());
    ASSERT_DOUBLE_EQ(util::LONGITUDE_MAX, result.east());
}
